...
[Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_fastq.ex1.md)
...
[Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_fastqQC.ex1.md)
...
Why does this happen [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_fastqQC.ex2.md)
...
cat adapters.fa
```
Why are there 2 different ones? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_trim.ex1.md)
...
What does Trimmomatic says it did? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_trim.ex2.md)
...
Why should this be done separatly? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_aln.ex1.md)
...
Why is it important to set Read Group information? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_aln.ex2.md)
...
Why did we pipe the output of one to the other? Could we have done it differently? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_aln.ex3.md)
...
Why did we use the ```-H``` switch? Try without. What happens? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_merge.ex1.md)
...
How many reads mapped and unmapped were there? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_sambam.ex3.md)
...
Why did we use both normal and tumor together? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_realign.ex3.md)

How could we make this go faster? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_realign.ex1.md)
How many regions did it think needed cleaning? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_realign.ex2.md)
...
What are duplicate reads? What are they caused by? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_markdup.ex1.md)
What are the ways to detect them? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_markdup.ex2.md)
...
Why is this important to do and not combine everything? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_markdup.ex3.md)

How many duplicates were there? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_markdup.ex4.md)
...
Find an indel. What's different between the snp callers? [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_vis.ex1.md)
Go to 1:47050562-47051207 what is interesting here?  [Solution](https://github.com/lletourn/Workshops/blob/ebiCancerWorkshop201407/blob/solutions/_vis.ex2.md)
